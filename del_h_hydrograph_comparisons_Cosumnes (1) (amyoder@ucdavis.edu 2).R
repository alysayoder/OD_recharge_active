...
#MW11----
MW11_1617 = MW_11[-(1:(which(MW_11$Date.Time..PDT. == '12/31/2015 23:45' | MW_11$Date.Time..PDT. == '12/31/15 23:45'))),-(4:14)]
...
#MW23----
MW23_1617 = MW_23[-(1:(which(MW_23$Date.Time == '12/31/15 23:45'))),-(4:14)]
...
#MW3----
MW3_1617 = MW_3[-(1:(which(MW_3$Date.Time..PDT. == '12/31/15 23:45'))),-(4:14)]
MW3_1617 = MW3_1617[,-(2)]
...
plot_MW5 <- ggplot(MW5_1617, aes(Dates5, MW5_1617$SWL..m.)) + geom_point() + theme_bw() + title("MW5") 
 

#MW7----
MW7_1617 = MW_7[-(1:71853),-(4:14)]
MW7_1617 = MW7_1617[,-(2)]
Dates7= as.POSIXct(MW7_1617$Date.Time, format = '%m/%d/%y %H:%M')
ggplot(MW7_1617, aes(Dates7, MW7_1617$SWL..m.))+geom_point()

#MW9----
MW9_1617 = MW_9[-(1:71845),-(4:14)]
MW9_1617 = MW9_1617[,-(2)]
...
#Amend mydat to include all data----
mydat["MW13"] <- MW13_1617$SWL..m.
