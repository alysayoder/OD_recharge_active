...
rechvol_lat <- function(begin, end, plot_title, print = TRUE) {
  # load packages
  ...
  # write pre-trimmed raster to file
  writeRaster(idw_begin, here::here("begin.GTiff"), format = "GTiff")
  writeRaster(idw_end, here::here("end.GTiff"), format = "GTiff")
